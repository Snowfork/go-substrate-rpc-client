...
func TestClientSubscribeInvalidArg(t *testing.T) {
	...
	check := func(shouldPanic bool, arg interface{}) {
		...
		client.Subscribe(context.Background(), "foo_bar", "", "", "", nil, arg)
	}
	check(true, nil)
	check(true, 1)
...
func TestClientSubscribe(t *testing.T) {
	...
	nc := make(chan int)
	count := 10
	sub, err := client.Subscribe(context.Background(), "nftest", "someSubscription", "", "", nc, count)
	if err != nil {
...
func TestClientSubscribeClose(t *testing.T) {
	...
	go func() {
		sub, err = client.Subscribe(context.Background(), "nftest2", "hangSubscription", "", "", nc, 999)
		errc <- err
	}()
...
func TestClientCloseUnsubscribeRace(t *testing.T) {
	...
	for i := 0; i < 20; i++ {
		client := DialInProc(server)
		nc := make(chan int)
		sub, err := client.Subscribe(context.Background(), "nftest", "someSubscription", "someSubscription", "someSubscription", nc, 3)
		if err != nil {
			t.Fatal(err)
		}
		go client.Close()
...
func TestClientNotificationStorm(t *testing.T) {
	...
	doTest := func(count int, wantError bool) {
		...
		// very quickly.
		nc := make(chan int)
		sub, err := client.Subscribe(ctx, "nftest", "someSubscription", "someSubscription", "someSubscription", nc, count)
		if err != nil {
			t.Fatal("can't subscribe:", err)
		}
